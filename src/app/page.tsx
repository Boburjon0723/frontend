    ...
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center bg-[#020617] text-white">
      ...
      >
        ...
        <p className="mb-8 text-[11px] text-slate-300/80 sm:text-xs">
          <span className="font-semibold">Boshlash</span> — mavjud hisob bilan tizimga kirish,{" "}
          <span className="font-semibold">Yangi hisob yaratish</span> — birinchi marta ro&apos;yxatdan o&apos;tish.
        </p>
        ...
        <div className="grid w-full max-w-3xl grid-cols-1 gap-3 text-left text-xs text-slate-200/80 sm:grid-cols-3 sm:text-sm">
          <div className="flex items-start gap-3 rounded-2xl bg-black/40 px-4 py-3 backdrop-blur-md border border-white/5">
            ...
            <div>
              <p className="font-semibold">Real-time chat va kanallar</p>
              <p className="text-[11px] text-slate-300/80">
                Guruhlar, kanallar va shaxsiy chatlar bir joyda.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 rounded-2xl bg-black/40 px-4 py-3 backdrop-blur-md border border-white/5">
            ...
            <div>
              <p className="font-semibold">Xavfsiz ekotizim</p>
              <p className="text-[11px] text-slate-300/80">
                Himoyalangan sessiyalar va ishonchli autentifikatsiya.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 rounded-2xl bg-black/40 px-4 py-3 backdrop-blur-md border border-white/5">
            ...
            <div>
              <p className="font-semibold">Moliya va hamyon</p>
              <p className="text-[11px] text-slate-300/80">
                Tranzaksiyalar va xarajatlarni kuzatish imkoniyati.
              </p>
            </div>
          </div>
        </div>
