...
export default function AddGroupMemberModal({
    ...
    return (
        <div className="fixed inset-0 z-[70] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in" onClick={onClose}>
            <GlassCard
                className="w-full max-w-md !p-0 flex flex-col max-h-[85vh] overflow-hidden !rounded-2xl border border-white/10 shadow-2xl animate-scale-up"
                onClick={(e) => e.stopPropagation()}
            >
                <div className="px-5 py-4 border-b border-white/10 flex justify-between items-center bg-white/5">
                    <h2 className="text-lg font-bold text-white">Saqlangan kontaktlar</h2>
