            ...
            >
                ...
                {listingIntro && (
                    <div className="mx-4 mt-4 rounded-xl border border-amber-400/30 bg-amber-500/10 px-3 py-2 text-[11px] text-amber-100/95 leading-snug">
                        ...
                        Tomonlar bir-birining to‘liq profili o‘rniga faqat e‘londagi ma’lumotlar va cheklangan
                        kartani ko‘radi.
                    </div>
                )}
                {/* Header Section */}
                <div className="flex flex-col items-center pt-10 pb-6 px-4">
                    ...
                    <p className="text-blue-400/60 text-[13px] mt-1 font-medium">
                        {listingIntro ? 'E‘londagi profil' : 'yaqinda tarmoqda edi'}
                    </p>
                </div>
                ...
                <div className="w-full space-y-1">
                    <div className="px-6 py-4 border-t border-white/5">
                        <h3 className="text-white text-[15px] font-medium">
                            {listingIntro ? '—' : hasPhone ? user.phone : 'Yashirilgan'}
                        </h3>
                        <p className="text-blue-400/40 text-xs">
                            {listingIntro ? 'Telefon va username e‘lon suhbatida berilmaydi' : 'Telefon raqami'}
                        </p>
                    </div>
                    ...
                    {listingIntro && user.profession && (
                        <>
                            ...
                            <div className="px-6 py-4">
                                ...
                                <p className="text-blue-400/40 text-xs mt-1">Kasb (e‘lon)</p>
                            </div>
                        </>
                    )}
                    ...
                    {listingIntro && listingPitch && (
                        <>
                            ...
                            <div className="px-6 py-4">
                                ...
                                <p className="text-blue-400/40 text-xs mt-1">E‘londagi tavsif</p>
                            </div>
                        </>
                    )}
